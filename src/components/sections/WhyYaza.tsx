...
const pillars = [
  { title: "Consulting Led", copy: "We start with the problem, not the resume.", Icon: IconCompass, color: "text-amber-deep" },
  { title: "Global Reach", copy: "A network that extends across India and beyond.", Icon: IconGlobe, color: "text-sky-deep" },
  { title: "Precision", copy: "Fewer profiles, better matches.", Icon: IconTarget, color: "text-moss-deep" },
  { title: "Reliability", copy: "The same discipline, every engagement.", Icon: IconShield, color: "text-amber-deep" },
  { title: "Range", copy: "Any IT role, any technology stack.", Icon: IconGrid, color: "text-sky-deep" },
];
